...
/**
 * An activity representing a list of Friends. This activity has different
 * presentations for handset and tablet-size devices. On handsets, the activity
 * presents a list of items, which when touched, lead to a
 * {@link FriendDetailActivity} representing item details. On tablets, the
 * activity presents the list of items and item details side-by-side using two
 * vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link FriendListFragment} and the item details (if present) is a
 * {@link FriendDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link FriendListFragment.Callbacks} interface to listen for item selections.
 */
public class FriendListActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.friend_detail_container) != null) {
			...
			((FriendListFragment) getSupportFragmentManager().findFragmentById(
					R.id.friend_list)).setActivateOnItemClick(true);
		}
	...
	/**
	 * Callback method from {@link FriendListFragment.Callbacks} indicating that
